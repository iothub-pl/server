...
describe('MODEL: Account', () => {
    ...
    describe('testing all instance method before save', ()=> {
        ...
        it('should have createAuthenticationEntity method', (done) => {
        ...
        it('should have getDateOfCreation method', (done) => {
             ...
             */
            should(account.getDateOfCreation()).be.undefined;
            done();
        });
        it('should have getDateOfLastUpdate method', (done) => {
             ...
             * because is not saved
             */
            should(account.getDateOfLastUpdate()).be.undefined;
            done();
        });
    });
    describe('testing all instance method after save', ()=> {
        ...
        describe('when calling getPassword method', ()=> {
            ...
            it('should not be equal with given password', (done) => {
                /**
                 * because now in object there is hashed password
                 */
                account.getPassword().should.not.equal(data.password);
                done();
            });
        });
        ...
        describe('when calling authenticate method', ()=> {
            ...
            it('should authenticate password', (done) => {
                /**
                 * it will only be true when will save account and post save hook will be called
                 */
                account.authenticate(data.password).should.be.true();
                done();
            });
        });
